...
class QuestionnairesControllerTest < ActionController::TestCase
  ...
  test "should create questionnaire" do
    assert_difference('Questionnaire.count') do
      post :create, questionnaire: { age: @questionnaire.age, city: @questionnaire.city, education_id: @questionnaire.education_id, sex: @questionnaire.sex }
    end
  ...
  test "should update questionnaire" do
    patch :update, id: @questionnaire, questionnaire: { age: @questionnaire.age, city: @questionnaire.city, education_id: @questionnaire.education_id, sex: @questionnaire.sex }
    assert_redirected_to questionnaire_path(assigns(:questionnaire))
  end
